...
// ==================== COUNTER ANIMATION (About Section - Stylish Glow Version) ====================
...
const animateCounters = () => {
  counters.forEach((counter) => {
    ...
    const update = (currentTime) => {
      ...
      // Add pulsing color + glow based on progress
      const hue = 180 + (progress * 100);
      counter.style.color = `hsl(${hue}, 90%, 50%)`;
      counter.style.textShadow = `0 0 ${10 + progress * 30}px hsl(${hue}, 100%, 70%)`;
